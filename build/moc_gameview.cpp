...
#include <memory>
#include "../../carcassonev2/Graphics/gameview.h"
...
QT_MOC_LITERAL(1, 9, 14), // "rotateTileView"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7) // "rotateN"

    },
    "GameView\0rotateTileView\0\0rotateN"
};
...
void GameView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->rotateTileView((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameView::rotateTileView)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameView::rotateTileView(int _t1)
{
