...
#include <memory>
#include "../../carcassonev2/Networking/server.h"
...
QT_MOC_LITERAL(5, 45, 11), // "closeServer"
QT_MOC_LITERAL(6, 57, 8), // "echoData"
QT_MOC_LITERAL(7, 66, 4) // "data"

    },
    "Server\0newConnection\0\0readyRead\0"
    "disconnected\0closeServer\0echoData\0"
    "data"
};
...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->closeServer(); break;
        case 4: _t->echoData((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    }
}
